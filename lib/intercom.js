...
module.exports.send = function (data)
{
	...
	return findOrCreateUserByPhone(phone).then(function (user)
	{
		if (!user) err.throwE('User not found with phone', phone);

		return findActiveConvo(user.id).then(function (activeConvo)
		{
